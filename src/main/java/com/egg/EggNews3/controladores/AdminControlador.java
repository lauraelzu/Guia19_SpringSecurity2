...
//        periodistaServicio.eliminar(dni);     // =>SQLIntegrityConstraintViolationException: Cannot delete or update a parent row: a foreign key constraint fails (`eggnews`.`noticia`, CONSTRAINT `FKe3xqmj9irkycyo3t026p3awlp` FOREIGN KEY (`creador_dni`) REFERENCES `usuario` (`dni`))
